...
class BlogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $posts = $em->getRepository('AppBundle:Post')->findLatest();
            ...
            return $this->render('blog/pages/index.html.twig', array('posts' => $posts));
    }
    ...
    {
        return $this->render('blog/pages/post_show.html.twig', array('post' => $post));
    }
    ...
    public function commentNewAction(Request $request, Post $post)
    {
        ...
        return $this->render('blog/pages/comment_form_error.html.twig', array(
            'post' => $post,
    ...
    public function commentFormAction(Post $post)
    {
        ...
        return $this->render('blog/pages/comment_form.html.twig', array(
            'post' => $post,
            'form' => $form->createView(),
        ));
